...
import 'package:asset_yug_debugging/features/Customers/presentation/pages/customer_extraFieldsForm.dart';
...
class CustomersCustomPage extends ConsumerStatefulWidget {
  ...
  const CustomersCustomPage({super.key, required this.companyId, required this.customerId});

  @override
  ConsumerState<CustomersCustomPage> createState() => _CustomersCustomPageState();
}
...
class _CustomersCustomPageState extends ConsumerState<CustomersCustomPage> {
  ...
  void initState() {
    super.initState();
    //companyId or customerId or objectid
    print("-----------------------------------");
    ...
    Future<String> getAllExtraFieldsData(String customerId) async { //could be objectId
    try {
      final response = await CompanyCustomerRepositoryImpl().getExtraFields(customerId);
  ...
  FutureBuilder<String> _buildFilesList() {
    return FutureBuilder(
      future: getAllExtraFieldsData(widget.customerId),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              onTap: () async {
                                final extraFieldData = await getAllExtraFieldsData(widget.customerId);
        ...
        builder: (context) {
          return Dialog(
            ...
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(dBorderRadius)),
            child: CustomerCreateCustomField(customerId: widget.customerId),
          );
        },
        context: context);
  }
